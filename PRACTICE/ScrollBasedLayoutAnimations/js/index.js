...
// Function to apply scroll-triggered animations to the galleries
const scroll = () => {
    // Define the galleries that exist in your HTML
    const galleries = [
    ...
    galleries.forEach(gallery => {
        ...
        if (galleryElement) {
            ...
            console.warn(`Element not found for ${gallery.id}`);
        }
    });
};
