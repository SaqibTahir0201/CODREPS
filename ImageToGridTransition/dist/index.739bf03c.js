...
const showGrid = ()=>{
    ...
    }).addLabel("start", 0)// hide enter button
    .to(DOM.enterCtrl, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        opacity: 0,
        onComplete: ()=>(0, _gsap.gsap).set(DOM.enterCtrl, {
                pointerEvents: "none"
            })
    }, "start")// use the gsap Flip plugin to animate the main image to the grid
    .add(()=>{
        DOM.grid.classList.add("grid--open");
        const imageState = (0, _flip.Flip).getState(DOM.contentItem);
    ...
    for (let item of DOM.gridItems){
        ...
        const delay = (0, _utils.map)(getDistance(item), 0, 1000, 0, 0.4);
        tl// animate in the grid item's labels
        .to(item.querySelector(".oh__inner"), {
            ...
            yPercent: 0,
            delay: delay
        }, "start")// Set the original positions of the grid items and animate them in
    ...
    tl// Animate in the main image label
    .to(DOM.gridItemTarget.querySelector(".oh__inner"), {
        ...
        yPercent: 0
    }, "start")// Animate out the big title spans and animate in the small title spans
    .to(DOM.contentTitleTexts, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        yPercent: (pos)=>pos % 2 ? 100 : -100,
        opacity: 0
    }, "start").to(DOM.gridTitleTexts, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        startAt: {
    ...
    .to(DOM.backCtrl, {
        ...
        xPercent: 0,
        opacity: 1
    }, "start")// Animate the color of the page
    .to(body, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
...
const hideGrid = ()=>{
    ...
    }).addLabel("start", 0).to(body, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        backgroundColor: bgcolor
    }, "start").to(DOM.gridItemTarget.querySelector(".oh__inner"), {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        yPercent: 101
    }, "start");
    for (let item of DOM.gridItems){
        const { x, y } = getInitialPosition(item);
        const delay = (0, _utils.map)(getDistance(item), 0, 1000, 0.4, 0);
        tl.to(item, {
            duration: animationSettings.duration,
            ease: animationSettings.ease,
            x: x,
            ...
            opacity: 0,
            delay: delay
        }, "start").to(item.querySelector(".oh__inner"), {
    ...
    tl.to(DOM.gridTitleTexts, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        xPercent: (pos)=>pos % 2 ? 50 : -50,
        opacity: 0
    }, "start").to(DOM.backCtrl, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        xPercent: 20,
        opacity: 0
    }, "start").to(DOM.contentTitleTexts, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        yPercent: 0,
        opacity: 1
    }, "start+=0.4").to(DOM.enterCtrl, {
        duration: animationSettings.duration,
        ease: animationSettings.ease,
        opacity: 1,
        onComplete: ()=>(0, _gsap.gsap).set(DOM.enterCtrl, {
...
},{"./utils":"72Dku","gsap":"fPSuC","gsap/Flip":"iKp6p"}],"72Dku":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequirec455")
